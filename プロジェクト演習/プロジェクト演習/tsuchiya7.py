...
if __name__ == "__main__":
    # 動画をフレームに分割して保存
    m_slice('Bro_seikai.mp4', 'frames1', 10, '.png')
    m_slice('Bro_seikai2.mp4', 'frames2', 10, '.png')

    # 2つの動画からフレームを取得してGIFに変換
    image_files1 = [f"frames1/out_{i}.png" for i in range(1, 95)]
    output_file1 = "output1.gif"
    duration_ms1 = 200
    loop_count1 = 0
    convert_to_gif(image_files1, output_file1, duration_ms1, loop_count1)

    image_files2 = [f"frames2/out_{i}.png" for i in range(1, 95)]
    output_file2 = "output2.gif"
    duration_ms2 = 200
    loop_count2 = 0
